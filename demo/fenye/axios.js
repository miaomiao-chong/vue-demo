! function (e, t) {
  ...
  return function (e) {
      ...
      e.exports = function (e) {
          return new Promise((function (t, n) {
              ...
              if (g.open(e.method.toUpperCase(), s(w, e.params, e.paramsSerializer),
                  ...
                  var S = (e.withCredentials || c(w)) && e.xsrfCookieName ? i.read(
      ...
      a.Axios = i, a.Cancel = n(2), a.CancelToken = n(26), a.isCancel = n(8), a.VERSION = n(10).version,
          a.all = function (e) {
      ...
      f.prototype.request = function (e) {
          ...
          this.interceptors.request.forEach((function (t) {
              "function" == typeof t.runWhen && !1 === t.runWhen(e) || (r = r &&
                  t.synchronous, n.unshift(t.fulfilled, t.rejected))
          }));
          var o, i = [];
